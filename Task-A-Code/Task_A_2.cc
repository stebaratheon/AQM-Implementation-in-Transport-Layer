...
NS_LOG_COMPONENT_DEFINE ("Task_A_2_Script");
...
main (int argc, char *argv[])
{
  ...
  lrWpanHelper_left.SetChannel(channel);
  ...
  lrWpanHelper_right.SetChannel(channel1);
  ...
  ipv6.SetBase (Ipv6Address ("3001:aaaa::"), Ipv6Prefix (64));
  ...
  ipv6.SetBase (Ipv6Address ("3001:bbbb::"), Ipv6Prefix (64));
  ...
  ipv6.SetBase (Ipv6Address ("3001:cccc::"), Ipv6Prefix (64));
  ...
  Simulator::Run ();
  monitor->SerializeToXmlFile(dir+"/lrpan.xml", false, false);
...
AvgThroughput = AvgThroughput/jk;
